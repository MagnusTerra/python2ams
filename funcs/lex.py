...
# Correct filename for Java code
detected_language = detect_language(java_code, filename="example.java")
print(f"Detected Language: {detected_language}")

# Test with an incorrect filename for Java code
detected_language = detect_language(java_code, filename="example.py")
print(f"Detected Language: {detected_language}")
